...
class __TwigTemplate_bb71836876f700affe7304bf501dc3a0 extends Template
{
    private $source;
    private $macros = [];
    ...
    <table class=\"table\">
        <tbody>
            <tr>
                ...
                <td>";
        // line 28
        echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, (isset($context["category"]) || array_key_exists("category", $context) ? $context["category"] : (function () { throw new RuntimeError('Variable "category" does not exist.', 28, $this->source); })()), "id", [], "any", false, false, false, 28), "html", null, true);
        echo "</td>
            </tr>
            <tr>
                <th>Name</th>
...
";
    ...
    {
        return array (  137 => 41,  132 => 39,  127 => 37,  119 => 32,  112 => 28,  88 => 6,  78 => 5,  59 => 3,  36 => 1,);
    }
...
<style>
 .table {
    ...
    <a href=\"{{ path('app_category_index') }}\"  class=\"btn btn-light\">back to list</a>
...
", "category/show.html.twig", "/Users/hoangnhan/Downloads/ASM_SEMI-26fa78b3864ea7a349dbc530076f4cb955b2245d/templates/category/show.html.twig");
    }
}
